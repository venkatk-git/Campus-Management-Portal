export default {
  ...
  footer: {
    class: [
      ...
      // Shape
      "border-t-0 border-b border-[#f1f5f91f]	 border-x-0",
  ...
  column: {
    headercell: ({ context, props }) => ({
      class: [
        ...
        // Position
        {
          "sticky z-20 border-b border-[#f1f5f91f]	":
        ...
        "border-0 border-b border-[#f1f5f91f]	 border-solid",
    ...
    bodycell: ({ props, context, state, parent }) => ({
      class: [
        //Position
        {
          "sticky box-border border-b border-[#f1f5f91f]	":
        ...
        "border-0 border-b border-[#f1f5f91f]	 border-solid",
        {
          "first:border-l border-r border-b border-[#f1f5f91f]	":
    ...
    filteroperator: {
      class: [
        ...
        // Shape
        "border-b border-[#f1f5f91f]	 border-solid",
        "rounded-t-md",
