  ...
  container: ({ props }) => ({
    class: [
      ...
      // Colors
      {
        ...
        "bg-green-100 dark:bg-green-700": props.message.severity == "success",
        "bg-orange-100/70 dark:bg-orange-500/20":
          props.message.severity == "warn",
        "bg-red-800 dark:bg-red-800": props.message.severity == "error",
      },
      {
        ...
        "border-orange-500 dark:border-orange-400":
          props.message.severity == "warn",
        "border-red-700 dark:border-red-600": props.message.severity == "error",
      },
      {
